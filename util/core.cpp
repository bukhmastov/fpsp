...
void Core::generate(unsigned int seed) {
    ...
    tasks.push_back(new Task(14, 2,  "Формирование М-последовательности с периодом N = 2<sup>s</sup> - 1"));
    ...
    tasks.push_back(new Task(22, 10, "Формирование троичных М-последовательностей"));
    // summary part
