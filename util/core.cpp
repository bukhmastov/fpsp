...
void Core::generate(unsigned int seed) {
    ...
    questions.push_back(new Question("В поле Галуа характеристики p=3 задан проверочный примитивный полином h(x)=x^4+2x^3+x^2+2. Сколько умножителей содержит схема формирования МП, исключая умножители на 1?", std::vector<QString>{"1", "3", "2", "4"}));
